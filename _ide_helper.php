...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getAccessToken($forceRefresh);
        }
                    /**
         * 
         *
         * @param \App\Services\UploadedFile $file
         * @param $attributes
         * @return array|mixed 
         * @throws EvoliException
         * @static 
         */ 
        public static function transferMedia($file, $attributes)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->transferMedia($file, $attributes);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getMediaInformation($streamingId)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getMediaInformation($streamingId);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getEndpoint($path);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function create360VideoSequence($url)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->create360VideoSequence($url);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getConversionProgress($url)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getConversionProgress($url);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function postDownloadPlaylist($url, $data)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->postDownloadPlaylist($url, $data);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getPlaylistDownloadToken()
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getPlaylistDownloadToken();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getPlaylistProgress($playlist_id)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getPlaylistProgress($playlist_id);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getPlaylistDownloadUrl($playlist_id)
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getPlaylistDownloadUrl($playlist_id);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\EvoliService $instance */
                        return $instance->getApiEndpoint($path);
        }
     ...
     */ 
         ...
         * @param \App\Services\Xapi\XapiActivityType|null $contextActivityType
         * @param $projectId
         * @return \App\Services\Xapi\Statement 
         * @static 
         */ 
        public static function createStatement($verb, $activityType, $activityDescription, $requestUrl, $activityName, $projectId = null, $activityExtension = null, $contextId = null, $contextName = null, $contextActivityType = null)
        {
                        /** @var \App\Services\Xapi\XapiService $instance */
                        return $instance->createStatement($verb, $activityType, $activityDescription, $requestUrl, $activityName, $projectId, $activityExtension, $contextId, $contextName, $contextActivityType);
        }
                    /**
         * 
         *
         * @param \App\Services\Xapi\Statement $statement
         * @return \TinCan\LRSResponse 
         * @throws Exception
         * @static 
         */ 
        public static function sendStatement($statement)
        {
                        /** @var \App\Services\Xapi\XapiService $instance */
                        return $instance->sendStatement($statement);
        }
                    /**
         * 
         *
         ...
         * @param int $limit
         * @return \App\Services\Xapi\LRSResponse 
         * @static 
         */ 
        public static function getStatements($from, $until, $limit)
        {
                        /** @var \App\Services\Xapi\XapiService $instance */
                        return $instance->getStatements($from, $until, $limit);
        }
...
namespace  { 
            ...
            class Evoli extends \App\Facades\Evoli {}
            class Image extends \Intervention\Image\Facades\Image {}
            class Xapi extends \App\Facades\Xapi {}
